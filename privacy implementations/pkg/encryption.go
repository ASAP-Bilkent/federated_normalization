...
func EncryptRobustSampleValues(params bgv.Parameters, pk *rlwe.PublicKey, parties []*Party) []*rlwe.Ciphertext {
...
func EncryptRobustLRValues(params bgv.Parameters, pk *rlwe.PublicKey, parties []*Party) ([]*rlwe.Ciphertext, []*rlwe.Ciphertext) {
	encryptor := bgv.NewEncryptor(params, pk)
	encoder := bgv.NewEncoder(params)
